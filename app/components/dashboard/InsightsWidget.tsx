...
const metrics = [
  { label: "Budget used", value: "85%", desc: "Spending vs monthly budget" },
  { label: "Savings rate", value: "84%", desc: "Income saved this month" },
  { label: "Goals progress", value: "78%", desc: "On track for yearly goals" },
];

export default function InsightsWidget() {
  const [tab, setTab] = useState<"overview" | "trends">("overview");
  const mainPercent = 85;
        ...
        <div className="relative h-32 w-32 shrink-0">
          <svg className="h-full w-full -rotate-90" viewBox="0 0 36 36">
            ...
            <path
              ...
              strokeWidth="2.5"
              strokeDasharray={`${mainPercent}, 100`}
              strokeLinecap="round"
              d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"
            />
            <defs>
          ...
          <span className="absolute inset-0 flex items-center justify-center text-2xl font-bold text-white">{mainPercent}%</span>
        </div>
